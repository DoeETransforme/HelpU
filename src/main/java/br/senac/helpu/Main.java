...
public class Main {
	public static void main(String[] args) {
		...
		PedidoDoacao pedido = new PedidoDoacao("ajude", "descricao",  LocalDate.of(2022,10, 10),StatusPedido.ATIVO, ong);
		PedidoDoacaoDAO daoPedido = new PedidoDoacaoDAOImpl();
		daoPedido.inserirPedidoDoacao(pedido);
		

		PropostaDoacao proposta = new PropostaDoacao(StatusProposta.ANALISE, doador, LocalDate.of(2022, 10, 10), ong, pedido);
