    ...
    , initial-scale=1.0">
			...
			<body>
				...
				<main>
					...
					<div class="titulo">
						<h1>Titulo: <c:out value="${pedidoDoacao.titulo}">
						</h1>
						<img src="Imagem.png" alt="" id="capa_pedido"> <img src="" alt="" class="ImagemPerfil_PF">
						<p>
							Por: <span id="NomeCompletoOng">
					...
					<div>
						...
						<a href="Cadastro_proposta.jsp" >
							<button type="button" class="padrao-input">Ajude e doe agora mesmo!</button>
						</a>
