    ...
    <div>
            ...
            <section>
                <div>
                    ...
                    <p>You say potato, I say starchy carbs. A vida é uma sucessão de sucessivos que sucedem
                        ...
                        tudo junto?. A única mulher que andou na linha o trem pegou.. O povo unido é gente pra caramba..
                    </p>
                </div>
                <figure>
        ...
        <footer>
            <div>
                ...
                <form>
                <div>
                    <a href="./resources/paginas/Cadastro_ONG"><button>Sou ONG</button></a>
                    <a href="./resources/paginas/cadastro-doador"><button>Sou pessoa fisica</button></a>
                </div>
                </form>
            </div>
